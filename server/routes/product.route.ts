...
import { addProduct, addProductToShop, editProduct, getAllCategories, getAllProducts, getAllProductsInShop, searchProduct, updateShopInventory } from '../controller/products.controller';
