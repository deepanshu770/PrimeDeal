      ...
      >
        <div className="mb-4">
          <h1 className="font-bold text-2xl text-textPrimary dark:text-white">
            Prime{" "}
            <span className="font-bold text-2xl text-brandOrange">Deal</span>
          </h1>
          <h3 className=" text-textSecondary dark:text-white my-4">
            Registering as {isAdmin ? "Admin" : "Customer"}
          </h3>
        </div>
        {/* Full name Input */}
        <div className="mb-4">
        ...
        <div className="mb-4">
          {loading ? (
            <Button
              disabled
              className="w-full bg-brandOrange text-white py-2 rounded-md hover:bg-opacity-90 transition border-transparent focus-visible:outline-noner-transparent"
            >
