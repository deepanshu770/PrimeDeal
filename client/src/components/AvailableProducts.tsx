                ...
                <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                        {products.map((product: ProductItem) => (
                            <Card key={product.id} className="w-full max-w-xs mx-auto shadow-lg rounded-lg overflow-hidden flex flex-col">
                                ...
                                <CardFooter className="p-4 pt-3">
                                    <Button
                                        ...
                                        className={`w-full text-white px-4 py-2 rounded-md ${product.outOfStock ? 'bg-gray-400 cursor-not-allowed' : 'bg-brandGreen hover:bg-brandGreen/80'}`}
                                    >
